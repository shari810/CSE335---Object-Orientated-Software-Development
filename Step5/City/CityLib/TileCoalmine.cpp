...
int TileCoalmine::GetProduction()
{
    if (mProduction == Production::NoProduction)
    {
        return 0;
    }
    if (mProduction == Production::LowProduction)
    {
        return LowProductionLevel;
    }
    if (mProduction == Production::MediumProduction)
    {
        return MediumProductionLevel;
    }
    if (mProduction == Production::FullProduction)
    {
